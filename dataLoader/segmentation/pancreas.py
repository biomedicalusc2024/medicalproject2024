...
def getPancreas(path):
    ...
    """
    kaggle_url = "tahsin/pancreasct-dataset"
    rawdata = datasetLoad(url=kaggle_url, path=path, datasetName="PancreasCT")

    if not rawdata:
        raise ValueError("Failed to fetch or process the Pancreas CT Dataset.")
