...
def getROND(path):
    url = "https://raw.githubusercontent.com/Mayo-Clinic-RadOnc-Foundation-Models/Radiation-Oncology-NLP-Database/main/2-Text%20Classification/Text_Classification.csv"
