...
def getHepatitisCPrediction(path):
    urls = ["https://www.kaggle.com/api/v1/datasets/download/fedesoriano/hepatitis-c-dataset"]
    return datasetLoad(urls=urls, path=path, datasetName="hepatitisCPrediction")
