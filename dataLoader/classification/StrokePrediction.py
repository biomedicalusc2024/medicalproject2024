...
def getStrokePrediction(path):
    urls = ["https://www.kaggle.com/api/v1/datasets/download/fedesoriano/stroke-prediction-dataset"]
    return datasetLoad(urls=urls, path=path, datasetName="strokePrediction")
